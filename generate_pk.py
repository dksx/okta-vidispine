...
config_doc = '<OAuth2ConfigurationDocument xmlns="http://xml.vidispine.com/schema/vidispine">'
try: 
    ...
    for key in keys['keys']:
        ...
        # print(f"{vs_key}\n")
        config_doc += f'\n\t<publicKey>{vs_key}</publicKey>'  
    
except Exception as exc:
    print(exc)

config_doc += '\n\t<expectedAudience>api://default</expectedAudience>\n\t<tokenUser>sub</tokenUser>\n</OAuth2ConfigurationDocument>'
print(config_doc)